...
class ExportToGISShapeFile(Module):
        ...
        def exportBuildingBlocks(self):
            ...
            for i in range(len(uuids)):
                ...
                feature.SetField("COM_IDD", currentAttList.getAttribute("COM_IDD").getDouble())
                feature.SetField("COM_OAD", currentAttList.getAttribute("COM_OAD").getDouble())
                ...
                feature.SetField("ORC_IDD", currentAttList.getAttribute("ORC_IDD").getDouble())
                feature.SetField("ORC_OAD", currentAttList.getAttribute("ORC_OAD").getDouble())
